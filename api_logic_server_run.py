...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 10.04.60, June 17, 2024 08:44:16):
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 10.04.60\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 10.04.60\n'
    msg += f'.. startup message: {start_up_message}\n'
