...
projectname="chinook"  # lower case, only
resourcegroup="chinook_rg"
...
# git clone https://github.com/apilogicserver/chinook.git
# cd chinook
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name chinook --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
