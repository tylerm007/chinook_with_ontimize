...
@Component({
  selector: 'InvoiceLine-home',
  templateUrl: './InvoiceLine-home.component.html',
  styleUrls: ['./InvoiceLine-home.component.scss']
})
export class InvoiceLineHomeComponent implements AfterViewInit {
