...
@Component({
  selector: 'MediaType-home',
  templateUrl: './MediaType-home.component.html',
  styleUrls: ['./MediaType-home.component.scss']
})
export class MediaTypeHomeComponent implements AfterViewInit {
