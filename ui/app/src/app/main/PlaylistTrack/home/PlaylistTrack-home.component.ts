...
@Component({
  selector: 'PlaylistTrack-home',
  templateUrl: './PlaylistTrack-home.component.html',
  styleUrls: ['./PlaylistTrack-home.component.scss']
})
export class PlaylistTrackHomeComponent implements AfterViewInit {
